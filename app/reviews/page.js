                  ...
                  {user?.role === 'executor' ? (
                    ...
                    <>
                      <div className="p-4 bg-blue-50 rounded-lg">
                        ...
                        <p className="text-3xl font-bold text-blue-600">{userProfile.stats.usersManaged}</p>
                      </div>
                      <div className="p-4 bg-green-50 rounded-lg">
                        <p className="text-sm text-gray-600 mb-1">Проектов</p>
                        <p className="text-3xl font-bold text-green-600">{userProfile.stats.projectsModerated}</p>
                      </div>
                      <div className="p-4 bg-purple-50 rounded-lg">
                        <p className="text-sm text-gray-600 mb-1">Тикетов</p>
                        <p className="text-3xl font-bold text-purple-600">{userProfile.stats.supportTickets}</p>
                      </div>
                    </>
                  ) : (
                    <>
                      <div className="p-4 bg-blue-50 rounded-lg">
                        <p className="text-sm text-gray-600 mb-1">Активные заказы</p>
                        <p className="text-3xl font-bold text-blue-600">{userProfile.stats.activeProjects}</p>
                      </div>
                      <div className="p-4 bg-green-50 rounded-lg">
                        <p className="text-sm text-gray-600 mb-1">Завершено</p>
                      ...
                      <div className="p-4 bg-purple-50 rounded-lg">
                        ...
                        <p className="text-3xl font-bold text-purple-600">{(userProfile.stats.totalSpent / 1000).toFixed(0)}K ₽</p>
                      </div>
                    </>
                  )}
                </div>
